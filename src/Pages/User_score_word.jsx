...
function User_score() {
    ...
    const Export_pdf = () => {
        ...
        วันที่ 8 ${m_th} 2566 ณ ห้องปฏิบัติการคอมพิวเตอร์ 2101`, width / 2, 10, { align: 'center' })
    ...
    useEffect(() => {
        ...
        const get_users = async () => {
            const get_data_as = await axios.get(`https://cloud-server-2.vercel.app/user_score/${change_m}`)
                        ...
                        <div className="container-fluid" >
                            ...
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    <h1 style={{ textAlign: 'center', fontWeight: "bold", color: "blue" }}>จัดการข้อมูลคะแนนสอบประจำเดือนที่ {m_th}</h1>
